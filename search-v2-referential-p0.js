...
(function(root){
  ...
  const intents = [
    ...
    {key:'alopecia',primaryId:'alopecie-causes-pelade-traitement',aliases:['perte de cheveux','chute de cheveux','cheveux qui tombent','alopecie','pelade','plaque sans cheveux'],hardVetoUnlessPositive:['cholesterol','poux','lentes']},
