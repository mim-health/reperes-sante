...
(function(root){
  ...
  const intents = [
    ...
    {key:'heart-failure-warning-signs',primaryId:'insuffisance-cardiaque-signes-aggravation',aliases:['insuffisance cardiaque aggravation','signes insuffisance cardiaque aggravation','essoufflement insuffisance cardiaque','jambes gonflees insuffisance cardiaque','chevilles gonflees insuffisance cardiaque','prise de poids insuffisance cardiaque','fatigue insuffisance cardiaque','decompensation cardiaque'],preferIf:['essoufflement','gonflees','poids','fatigue']},
    {key:'heart-failure-monitoring',primaryId:'insuffisance-cardiaque-surveillance-poids',aliases:['se peser insuffisance cardiaque','poids insuffisance cardiaque surveillance','balance insuffisance cardiaque','surveiller insuffisance cardiaque maison','surveillance insuffisance cardiaque'],preferIf:['peser','balance','surveillance']},
    {key:'heart-failure-salt-fluid',primaryId:'insuffisance-cardiaque-sel-boissons',aliases:['sel insuffisance cardiaque','manger sans sel insuffisance cardiaque','boire insuffisance cardiaque','limiter boissons insuffisance cardiaque','restriction hydrique insuffisance cardiaque','eau insuffisance cardiaque'],preferIf:['sel','boire','boissons','eau']},
    {key:'breast-lump-change',primaryId:'sein-boule-changement-quand-consulter',aliases:['boule dans le sein','boule au sein','masse dans le sein','changement du sein','mamelon retracte','ecoulement mamelon','peau orange sein','anomalie sein','boule aisselle sein'],preferIf:['boule','masse','mamelon','ecoulement','peau']},
    {key:'breast-cancer-followup',primaryId:'cancer-sein-surveillance-recidive',aliases:['surveillance apres cancer du sein','suivi apres cancer du sein','examens apres cancer du sein','rechercher recidive cancer du sein','scanner apres cancer du sein','pet scan apres cancer du sein','marqueurs tumoraux cancer du sein','mammographie apres cancer du sein'],preferIf:['surveillance','suivi','recidive','scanner','mammographie']},
