...
(function(){
  ...
  const homeAfter=['scoped-category-search-v1.js?v=20260823-2','alphabetical-categories-v1.js?v=20260823-2','category-query-routing-v1.js?v=20260823-1','maca-eight-categories-v1.js?v=20260829-2','vrai-faux-ui.js','source-ui.js','maca-daily-editorial-data.js?v=20260829-2','maca-daily-editorial.js?v=20260829-mag1','maca-daily-feature.js?v=20260829-1','search-v1-engine.js?v=20260826-2'];
  /* Library uses the canonical category controller only. The legacy hardfix had an obsolete 8-category taxonomy and could hide Cancer/Seniors. */
  const libraryAfter=['maca-eight-categories-v1.js?v=20260829-2','source-ui.js','search-v1-engine.js?v=20260826-2','maca-section-identities.js?v=20260829-1'];
