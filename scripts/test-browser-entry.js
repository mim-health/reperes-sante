...
const required=['MACA_CORPUS_READY','MACA_BUILD_CANONICAL_CORPUS','window.healthQuestions=canonical.slice()','window.extraAuditedQuestions=[]','app.js?v=20260825-corpusv2','maca:v2-ui-ready'];
