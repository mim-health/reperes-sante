/* MACA SANTE — assistant V2 floating entrypoint. Shared home/library/fiche component. */
(function(){
  'use strict';

  if(!document.body) return;
  const supported=document.body.classList.contains('library-page')||document.body.classList.contains('maca-magazine-v1')||document.getElementById('seo-fiche');
  if(!supported) return;
