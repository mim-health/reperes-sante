...
(function(){
  ...
  launcher.innerHTML='<span class="maca-assistant-launcher-icon" aria-hidden="true">💬</span><span class="maca-assistant-launcher-label">Assistant MACA</span><span class="maca-assistant-launcher-badge">Bêta</span>';
  ...
  panel.innerHTML=`<header class="maca-assistant-head"><div class="maca-assistant-head-copy"><strong class="maca-assistant-head-title" id="maca-assistant-title">Assistant MACA</strong><span class="maca-assistant-head-subtitle">Retrouvez une réponse parmi nos fiches santé vérifiées</span></div><button class="maca-assistant-close" type="button" aria-label="Fermer l’assistant">×</button></header><iframe class="maca-assistant-frame" title="Assistant MACA" src="assistant-alpha.html?v=20260902-catfix2"></iframe><span class="maca-assistant-screen-reader" aria-live="polite" id="maca-assistant-status"></span>`;
